...
const openModal  = () => { modal.classList.add('open'); formView.style.display = ''; doneView.style.display = 'none'; };
...
submitBtn.addEventListener('click', () => {
  ...
  if (attending === 'yes') {
    ...
    doneMsg.textContent = "Daphne is going to be so happy to see you. We'll send a reminder closer to the day.";
    blastConfetti();
  } else {
    doneTitle.textContent = `We'll miss you, ${name}.`;
    doneMsg.textContent = "Thanks for letting us know — we'll save you some cake in spirit. ☀";
  }
});

// ── Confetti ──
const palette = ['#ee8158', '#fcd45b', '#7cc4dd', '#3a7bd5', '#f5a3a3', '#ffffff'];
